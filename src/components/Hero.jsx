...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="md:w-3/6 w-full">
        <div>
          <h1 className="text-white text-5xl font-bold">
            E-commerce <br />Your Digital Arts, <br />
            <span className="text-gradient">NFT</span> Collections
          </h1>
          <p className="text-gray-500 font-semibold text-sm mt-3">
            Mint Publish and Collect Your NFTs Its Now or Never.
          </p>
        </div>
      ...
      >
        <img
          src="https://media.wired.com/photos/62018c27ab03687ec206abf7/master/w_1920,c_limit/Culture_BAYC_2HDDWE4.jpg"
          alt="NFT Art"
          className="h-60 w-full object-cover"
        />
        <div className="flex justify-start items-center p-3">
          <Identicon
            string={connectedAccount ? connectedAccount : 'Login Your Wallet'}
            size={50}
